  ...
  --policy-document '{
    ...
    "Statement": [
      ...
      },
      {
        ...
        "Resource": [
          "arn:aws:ecs:us-east-1:<ACCOUNT_ID>:cluster/*-ecs-cluster-main",
          "arn:aws:ecs:us-east-1:<ACCOUNT_ID>:service/*-ecs-cluster-main/*-app*"
        ]
      },
      {
        "Sid": "ECSTaskDef",
...
# ECS running counts
export AWS_PROFILE=steven-prod
for cluster in p-ecs-cluster-main h-ecs-cluster-main; do
  echo "=== $cluster ==="
