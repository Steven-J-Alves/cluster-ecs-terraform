...
variable "vpc_public_subnets" {
  ...
  type        = list(string)
  default     = ["10.220.0.0/20", "10.220.16.0/20", "10.220.32.0/20", "10.220.48.0/20"]
}
...
variable "vpc_private_subnets" {
  ...
  type        = list(string)
  default     = ["10.220.64.0/20", "10.220.80.0/20", "10.220.96.0/20", "10.220.112.0/20"]
}
...
variable "vpc_database_subnets" {
  ...
  type        = list(string)
  default     = ["10.220.128.0/20", "10.220.144.0/20", "10.220.160.0/20", "10.220.176.0/20"]
}
